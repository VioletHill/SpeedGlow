...
-(CCAction *) rotateAction
{
    CCAction* action=[CCSequence actions:[CCRotateBy actionWithDuration:0.5 angle:20],[CCRotateBy actionWithDuration:0.5 angle:-20],[CCCallFunc actionWithTarget:self selector:@selector(isNeedStop:)],[CCRotateBy actionWithDuration:0.5 angle:-20],[CCRotateBy actionWithDuration:0.5 angle:20],[CCCallFunc actionWithTarget:self selector:@selector(isNeedStop:)],nil];
    return  action;
}

-(CCAction*) scaleAction
{
    CCAction* action=[CCSequence actions:[CCScaleTo actionWithDuration:0.5 scale:1.2],[CCScaleTo actionWithDuration:0.5 scale:1.0],[CCCallFunc actionWithTarget:self selector:@selector(isNeedStop:)],nil];
    return action;
}
