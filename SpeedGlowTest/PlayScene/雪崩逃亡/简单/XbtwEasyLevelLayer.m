...
@implementation XbtwEasyLevelLayer
...
-(void) unlockLevel
{
    if ([Setting sharedSetting].isNeedEffect)
    {
        int sun=[[UserData sharedUserData] getSunByScene:kXBTW andLevel:kEASY];
        playEffectAction=[CCSequence actions:
                      ...
                      [CCDelayTime actionWithDuration:1.5],[CCCallFuncND actionWithTarget:self selector:@selector(playNum:data:) data:(void*)XbtwEasySunNum],
